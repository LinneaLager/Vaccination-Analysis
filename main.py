...
from Datahandler import plot_vaccinations as pv
...
parser.add_argument('-d', '--dataflag', type=str, required=True, help = 'Select the field you would like to analyse: total_vaccinations,	people_vaccinated,	people_fully_vaccinated,	daily_vaccinations_raw,	daily_vaccinations,	total_vaccinations_per_hundred,	people_vaccinated_per_hundred,	people_fully_vaccinated_per_hundred,	daily_vaccinations_per_million')
args = parser.parse_args()

if __name__ == '__main__':

    if args.country2 == None:
